...
public class PantherBattleScreen extends Screen {
    ...
    private static final int HORIZONTAL_SPACING   = 400;
    ...
    public PantherBattleScreen() {
        this("PANTHER_BATTLE", "POST_PANTHER_BATTLE");
    }

    public PantherBattleScreen(String screenName, String nextScreen) {
        super(screenName);
    ...
    @Override
    public void prepare() {
        background   = Resources.images().get("Cenários/Batalha3.png");
        playerSprite = Resources.images().get("Sprites/Personagens/" + getPlayerType() + ".png");

        BufferedImage panteraSprite = Resources.images().get("Sprites/Inimigos/PanteraRast.png");

        enemies.clear();
        enemies.add(new Enemy("Pantera Deslocadora", panteraSprite, 90));
