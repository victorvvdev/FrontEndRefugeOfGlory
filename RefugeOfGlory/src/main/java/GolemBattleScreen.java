...
public class GolemBattleScreen extends Screen {
    ...
    public GolemBattleScreen() {
        this("GOLEM_BATTLE", "POST_GOLEM_BATTLE");
    }
    ...
    public void prepare() {
        ...
        BufferedImage golemSprite = Resources.images().get("Sprites/Inimigos/Golem.png");

        enemies.clear();
        enemies.add(new Enemy("Golem", golemSprite, 80));
