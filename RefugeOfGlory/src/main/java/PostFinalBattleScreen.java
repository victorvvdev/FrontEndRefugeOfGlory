...
public class PostFinalBattleScreen extends Screen {
    ...
    public PostFinalBattleScreen() {
        super("POST_FINAL_BATTLE");
    }
    ...
    public void prepare() {
        ...
        if (dialogs.isEmpty()) {
            dialogs.add(new DialogEntry(null,
                    "A fera não estava mais viva. Nada mais importava, o guerreiro estava de pé, sua arma lascada, seu corpo cansado, mas de pé. " +
                            "Olhou para o tronco de árvore seco, o velho permanecia lá. E pela primeira vez, ele sorriu."));

            dialogs.add(new DialogEntry(null,
                    "Após a matança, o destemido guerreiro seguiu em passos lentos ao seu destino final, o Refúgio da Glória."));
        }
    ...
    private void advanceDialog() {
        if (!Game.screens().current().getName().equals("POST_FINAL_BATTLE")) return;
    ...
    private void finishScene() {
        ...
        Game.loop().perform(1, () -> Game.screens().display("FINAL_NARRATIVE"));
    }
