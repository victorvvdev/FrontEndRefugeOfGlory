...
public class PostGolemBattleScreen extends Screen {
    ...
    public PostGolemBattleScreen() { super("POST_GOLEM_BATTLE"); }

    @Override
    public void prepare() {
        backgroundImage = Resources.images().get("Cenários/Parte7.png");

        if (dialogs.isEmpty()) {
            dialogs.add(new DialogEntry(null,
                    "Dentro da caverna, ao fundo, enrolada na própria cauda, a fera o esperava com seus olhos negros. " +
                            "Deu um rosnado que parecia vir dos quatro cantos da caverna e em seguida saltou, " +
                            "o mundo sumiu por um instante."));
        }
    ...
    private void advanceDialog() {
        if (!Game.screens().current().getName().equals("POST_GOLEM_BATTLE")) return;
    ...
    private void finishScene() {
        ...
        Game.loop().perform(1, () -> Game.screens().display("PANTHER_BATTLE"));
    }
